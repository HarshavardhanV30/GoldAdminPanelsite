...
const SellGoldPrice = () => {
  ...
  const fetchPrices = useCallback(async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://goldbackend-production-eaef.up.railway.app/sellprice/all");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        ...
        await axios.put(`https://goldbackend-production-eaef.up.railway.app/sellprice/${editingId}`, payload);
        alert("Selling rate updated successfully!");
      } else {
        // POST Request: /sellprice/add
        await axios.post("https://goldbackend-production-eaef.up.railway.app/sellprice/add", payload);
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm("Are you sure you want to permanently delete this selling price history item?")) {
      try {
        ...
        await axios.delete(`https://goldbackend-production-eaef.up.railway.app/sellprice/delete/${id}`);
