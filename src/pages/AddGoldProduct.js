...
<div><label style={styles.label}>Filter by Purity</label><select value={purityFilter} onChange={e=>setPurityFilter(e.target.value)} style={styles.filter}><option value="All">All Purity Levels</option><option>24K</option><option>22K</option><option>18K</option><option>Fine Silver (999 Silver)</option><option>Sterling Silver (925 Silver)</option><option>Coin Silver (900 Silver)</option><option>Britannia Silver (958 Silver)</option><option>Argentium Silver (960 Purity)</option><option>Tibetan / Tribal Silver (Alloy with lower silver content, often 30% to 50%)</option></select></div>
<div><label style={styles.label}>Filter by Category</label><select value={categoryFilter} onChange={e=>setCategoryFilter(e.target.value)} style={styles.filter}><option value="All">All Categories</option><option>Gold Rings</option><option>Gold Necklaces</option><option>Gold Pendants</option><option>Gold Earrings</option><option>Gold Bracelets</option><option>Gold Bangles</option><option>Gold Chains</option><option>Gold Mangalsutra</option><option>Gold Anklets</option><option>Gold Nose Pins & Septum Rings</option><option>Gold Brooches & Pins</option><option>Gold Toe Rings</option><option>Gold Armlets / Bajuband</option><option>Gold Maang Tikka & Head Jewelry</option><option>Gold Jewelry Sets</option><option>Gold Cufflinks & Shirt Studs</option><option>Gold Charm Bracelets & Anklets</option><option>Gold Lockets</option><option>Gold Waist Chains / Kamarbandh</option><option>Gold Coins & Bars</option><option>Silver Rings</option><option>Silver Necklaces</option><option>Silver Pendants</option><option>Silver Earrings</option><option>Silver Bracelets</option><option>Silver Bangles</option><option>Silver Chains</option><option>Silver Mangalsutra</option><option>Silver Anklets</option><option>Silver Nose Pins & Septum Rings</option><option>Silver Brooches & Pins</option><option>Silver Toe Rings</option><option>Silver Armlets / Bajuband</option><option>Silver Maang Tikka & Head Jewelry</option><option>Silver Jewelry Sets</option><option>Silver Cufflinks & Shirt Studs</option><option>Silver Charm Bracelets & Anklets</option><option>Silver Lockets</option><option>Silver Waist Chains / Kamarbandh</option><option>Silver Coins & Bars</option></select></div>
</div>
...
<FormSelect label="Category Name" options={["Gold Rings","Gold Necklaces","Gold Pendants","Gold Earrings","Gold Bracelets","Gold Bangles","Gold Chains","Gold Mangalsutra","Gold Anklets","Gold Nose Pins & Septum Rings","Gold Brooches & Pins","Gold Toe Rings","Gold Armlets / Bajuband","Gold Maang Tikka & Head Jewelry","Gold Jewelry Sets","Gold Cufflinks & Shirt Studs","Gold Charm Bracelets & Anklets","Gold Lockets","Gold Waist Chains / Kamarbandh","Gold Coins & Bars","Silver Rings","Silver Necklaces","Silver Pendants","Silver Earrings","Silver Bracelets","Silver Bangles","Silver Chains","Silver Mangalsutra","Silver Anklets","Silver Nose Pins & Septum Rings","Silver Brooches & Pins","Silver Toe Rings","Silver Armlets / Bajuband","Silver Maang Tikka & Head Jewelry","Silver Jewelry Sets","Silver Cufflinks & Shirt Studs","Silver Charm Bracelets & Anklets","Silver Lockets","Silver Waist Chains / Kamarbandh","Silver Coins & Bars"]} value={formData.category_name} onChange={v=>handleInputChange("category_name",v)} required/>
<FormSelect label="Purity" options={["24K","22K","18K","Fine Silver (999 Silver)","Sterling Silver (925 Silver)","Coin Silver (900 Silver)","Britannia Silver (958 Silver)","Argentium Silver (960 Purity)","Tibetan / Tribal Silver (Alloy with lower silver content, often 30% to 50%)"]} value={formData.purity} onChange={v=>handleInputChange("purity",v)} required/>
