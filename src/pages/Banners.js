...
const BannerManagement = () => {
  ...
  const fetchBanners = async () => {
    try {
      const response = await fetch("https://goldbackend-production-eaef.up.railway.app/banners/bannerall");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let url = "https://goldbackend-production-eaef.up.railway.app/banners/add";
      let method = "POST";

      if (editId) {
        url = `https://goldbackend-production-eaef.up.railway.app/banners/update/${editId}`;
        method = "PUT";
      }
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this banner?")) {
      try {
        const response = await fetch(`https://goldbackend-production-eaef.up.railway.app/banners/${id}`, {
          method: "DELETE",
        });
