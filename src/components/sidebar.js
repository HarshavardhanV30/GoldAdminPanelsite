      ...
      <aside className={`sidebar ${isOpen ? "open" : "closed"}`}>
        ...
        <nav>
          ...
          <NavLink to="/policy" className="nav-item">
            ...
            {isOpen && <span className="nav-text">Policy</span>}
            {isOpen && <FaEllipsisH className="ellipsis" />}
          </NavLink>
          ...
          <NavLink to="/AddBanners" className="nav-item">
            <FaUsers className="icon" />
            {isOpen && <span className="nav-text">AddBanners</span>}
            {isOpen && <FaEllipsisH className="ellipsis" />}
          </NavLink>

          <NavLink to="/AddGoldProducts" className="nav-item">
            <FaBox className="icon" />
            {isOpen && <span className="nav-text">AddGoldProducts</span>}
            {isOpen && <FaEllipsisH className="ellipsis" />}
          </NavLink>

          <NavLink to="/categoryName" className="nav-item">
            <FaShoppingCart className="icon" />
            {isOpen && <span className="nav-text">AddCategory</span>}
            {isOpen && <FaEllipsisH className="ellipsis" />}
          </NavLink>
          <NavLink to="/AddPhonenumbers" className="nav-item">
            <FaShoppingCart className="icon" />
